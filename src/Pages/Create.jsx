...
function Myform(){
    ...
    //                 />
    //                 <label htmlFor="upload" class="flex items-center border border-gray-400 rounded pr-2 mx-5 text-blue-400 cursor-pointer text-sm"><TbFileUpload class="mx-2 color=red text-xl" />Upload Image
    //                 </label>
    //                 <input id="upload" type="file" accept="image/jpg, image/jpeg, image/gif" className="hidden"/>
